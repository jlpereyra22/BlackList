            ...
            return (
              <tr key={row.id}>
                ...
                <td data-label="Acciones" className="cell-actions">
                  <button className="btn btn--sm btn--nowrap" onClick={() => setEditingId(row.id)}>Editar</button>
                  <button className="btn btn--sm btn--danger btn--nowrap" onClick={() => onDelete(row.id)}>Borrar</button>
                </td>
              </tr>
            );
          })}
